...
var G__13093 = request;
var G__13094 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__13093,G__13094) : ajax.formats.get_format.call(null,G__13093,G__13094));
} else {
...
return cljs.core.some((function (p1__13103_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__13103_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__13105){
var map__13108 = p__13105;
var map__13108__$1 = cljs.core.__destructure_map(map__13108);
var request = map__13108__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13108__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__13109 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__13109.cljs$core$IFn$_invoke$arity$1 ? fexpr__13109.cljs$core$IFn$_invoke$arity$1(response) : fexpr__13109.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__13111){
var map__13112 = p__13111;
var map__13112__$1 = cljs.core.__destructure_map(map__13112);
var request = map__13112__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13112__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__13110_SHARP_){
return ajax.formats.get_accept_entries(request,p1__13110_SHARP_);
