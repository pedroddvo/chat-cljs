...
var i_10441 = (self__.level + (1));
while(true){
if((i_10441 <= (new_level + (1)))){
(update[i_10441] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_10443 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_10443[i]));
} else {
x__$2.forward.push((((i < links_10443.length))?(links_10443[i]):null));
}

if((i < links_10443.length)){
(links_10443[i] = x__$2);
} else {
links_10443.push(x__$2);
}
...
var i_10445 = (0);
while(true){
if((i_10445 <= self__.level)){
var links_10446 = (update[i_10445]).forward;
if((x__$1 === (((i_10445 < links_10446.length))?(links_10446[i_10445]):null))){
(links_10446[i_10445] = (x__$1.forward[i_10445]));

var G__10447 = (i_10445 + (1));
i_10445 = G__10447;
continue;
} else {
var G__10448 = (i_10445 + (1));
i_10445 = G__10448;
continue;
}
} else {
...
var G__10450 = nx;
var G__10451 = (level__$1 - (1));
x = G__10450;
level__$1 = G__10451;
continue;
} else {
var G__10452 = x;
var G__10453 = (level__$1 - (1));
x = G__10452;
level__$1 = G__10453;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__10455 = nx;
var G__10456 = (level__$1 - (1));
x = G__10455;
level__$1 = G__10456;
continue;
} else {
var G__10457 = x;
var G__10458 = (level__$1 - (1));
x = G__10457;
level__$1 = G__10458;
continue;
}
