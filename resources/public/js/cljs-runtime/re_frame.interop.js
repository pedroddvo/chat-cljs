...
return [(function (){var pred__11916 = cljs.core.instance_QMARK_;
var expr__11917 = reactive_val;
if(cljs.core.truth_((pred__11916.cljs$core$IFn$_invoke$arity$2 ? pred__11916.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__11917) : pred__11916.call(null,reagent.ratom.RAtom,expr__11917)))){
return "ra";
} else {
if(cljs.core.truth_((pred__11916.cljs$core$IFn$_invoke$arity$2 ? pred__11916.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__11917) : pred__11916.call(null,reagent.ratom.RCursor,expr__11917)))){
return "rc";
} else {
if(cljs.core.truth_((pred__11916.cljs$core$IFn$_invoke$arity$2 ? pred__11916.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__11917) : pred__11916.call(null,reagent.ratom.Reaction,expr__11917)))){
return "rx";
} else {
if(cljs.core.truth_((pred__11916.cljs$core$IFn$_invoke$arity$2 ? pred__11916.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__11917) : pred__11916.call(null,reagent.ratom.Track,expr__11917)))){
return "tr";
} else {
return "other";
}
