...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__13128 = cljs.core.second(format);
var G__13129 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__13128,G__13129) : ajax.easy.keyword_response_format_element.call(null,G__13128,G__13129));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13131_SHARP_){
return ajax.easy.keyword_response_format_element(p1__13131_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__13132){
var map__13133 = p__13132;
var map__13133__$1 = cljs.core.__destructure_map(map__13133);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13133__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13133__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13133__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__13134){
var vec__13135 = p__13134;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13135,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13135,(1),null);
var fexpr__13138_13171 = (cljs.core.truth_(ok)?h:e);
(fexpr__13138_13171.cljs$core$IFn$_invoke$arity$1 ? fexpr__13138_13171.cljs$core$IFn$_invoke$arity$1(result) : fexpr__13138_13171.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__13142){
var map__13143 = p__13142;
var map__13143__$1 = cljs.core.__destructure_map(map__13143);
var opts = map__13143__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13143__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13143__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13143__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13143__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13143__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
