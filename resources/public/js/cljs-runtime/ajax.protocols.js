...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12929 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_12929(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_12930 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_12930(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_12931 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_12931(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_12932 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_12932(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_12933 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_12933(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_12934 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_12934(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_12939 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_12939(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_12940 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_12940(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_12942 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_12942(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_12947 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_12947(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k12915,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k12915,else__5346__auto__);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__12914){
var self__ = this;
var G__12914__$1 = this;
return (new cljs.core.RecordIter((0),G__12914__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this12916,other12917){
var self__ = this;
var this12916__$1 = this;
return (((!((other12917 == null)))) && ((((this12916__$1.constructor === other12917.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.status,other12917.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.body,other12917.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.status_text,other12917.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.headers,other12917.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.was_aborted,other12917.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this12916__$1.__extmap,other12917.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k12915){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k12915);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__12914){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__12925 = cljs.core.keyword_identical_QMARK_;
var expr__12926 = k__5352__auto__;
if(cljs.core.truth_((pred__12925.cljs$core$IFn$_invoke$arity$2 ? pred__12925.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__12926) : pred__12925.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__12926)))){
return (new ajax.protocols.Response(G__12914,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12925.cljs$core$IFn$_invoke$arity$2 ? pred__12925.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__12926) : pred__12925.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__12926)))){
return (new ajax.protocols.Response(self__.status,G__12914,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12925.cljs$core$IFn$_invoke$arity$2 ? pred__12925.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12926) : pred__12925.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__12926)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__12914,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12925.cljs$core$IFn$_invoke$arity$2 ? pred__12925.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12926) : pred__12925.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__12926)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__12914,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__12925.cljs$core$IFn$_invoke$arity$2 ? pred__12925.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12926) : pred__12925.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__12926)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__12914,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__12914),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__12914){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__12914,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__12918){
var extmap__5385__auto__ = (function (){var G__12928 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__12918,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__12918)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__12928);
} else {
return G__12928;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__12918),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__12918),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__12918),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__12918),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__12918),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
