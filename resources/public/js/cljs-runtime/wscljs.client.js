...
var pred__12175 = cljs.core._EQ_;
var expr__12176 = socket.readyState;
if(cljs.core.truth_((pred__12175.cljs$core$IFn$_invoke$arity$2 ? pred__12175.cljs$core$IFn$_invoke$arity$2((0),expr__12176) : pred__12175.call(null,(0),expr__12176)))){
return new cljs.core.Keyword(null,"connecting","connecting",-1347943866);
} else {
if(cljs.core.truth_((pred__12175.cljs$core$IFn$_invoke$arity$2 ? pred__12175.cljs$core$IFn$_invoke$arity$2((1),expr__12176) : pred__12175.call(null,(1),expr__12176)))){
return new cljs.core.Keyword(null,"open","open",-1763596448);
} else {
if(cljs.core.truth_((pred__12175.cljs$core$IFn$_invoke$arity$2 ? pred__12175.cljs$core$IFn$_invoke$arity$2((2),expr__12176) : pred__12175.call(null,(2),expr__12176)))){
return new cljs.core.Keyword(null,"stopping","stopping",1036724975);
} else {
if(cljs.core.truth_((pred__12175.cljs$core$IFn$_invoke$arity$2 ? pred__12175.cljs$core$IFn$_invoke$arity$2((3),expr__12176) : pred__12175.call(null,(3),expr__12176)))){
 ...
 *   
 */
wscljs.client.create = (function wscljs$client$create(url,p__12178){
var map__12179 = p__12178;
var map__12179__$1 = cljs.core.__destructure_map(map__12179);
var handler_map = map__12179__$1;
var on_open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12179__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12179__$1,new cljs.core.Keyword(null,"on-message","on-message",1662987808));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12179__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12179__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
