...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15801 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15801(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_15809 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_15809(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_15814 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_15814(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_15815 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_15815(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15816 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15816(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15817 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15817(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__15792,callback){
var map__15793 = p__15792;
var map__15793__$1 = cljs.core.__destructure_map(map__15793);
var input = map__15793__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15793__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15793__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
